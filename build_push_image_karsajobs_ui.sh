...
# Melakukan proses build, mengacu pada file Dockerfile dengan nama image ayiakbarmaulana/karsajobs-ui:$TAG 
docker build -t ayiakbarmaulana/karsajobs-ui:$TAG .

# Mengubah nama image / repository, disesuaikan dengan name repository ghcr.io atau github packages
docker tag ayiakbarmaulana/karsajobs-ui:$TAG ghcr.io/ayiakbarmaulana/karsajobs-ui:$TAG
...
docker push ghcr.io/ayiakbarmaulana/karsajobs-ui:$TAG
